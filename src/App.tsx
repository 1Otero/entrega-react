  ...
  return (
    <>
      ...
      <button onClick={() => setShowCart(!showCart)} className={`${!showCart?"bg-green-400":"bg-red-500"} p-2`}>
       <div>{showCart?<div><p className='w-2/3'>Hide cart</p><img className='w-2/3' src='/ocultarobajar.svg'/></div>:<div><p>View cart</p><img rel="stylesheet" src="/cart.svg"/></div>}</div>
      </button>
