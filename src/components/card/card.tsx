...
function card({cardProduct, setLoad, setAlertGlobal, setShowCart, setProductCard}:{cardProduct: Product[], setLoad:Function, setAlertGlobal:Function, setShowCart:Function, setProductCard:Function}){
  ...
  return <>
    ...
    {cardProduct.length>0?<button className="m-2 inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800" onClick={comprar}>Validar compra</button>:<div></div>} 
