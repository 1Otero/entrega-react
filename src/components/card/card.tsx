...
function card({cardProduct, setLoad, setAlertGlobal, setShowCart, setProductCard, setIsPago, isPago, setViewTransation}:{cardProduct: Product[], setLoad:Function, setAlertGlobal:Function, setShowCart:Function, setProductCard:Function, setIsPago:Function, isPago:Boolean, setViewTransation:Function}){
  ...
  return <>
    ...
    {ver?<p>
        <Pago  setViewTransation={setViewTransation} setIsPago={setIsPago} isPago={isPago} infoTarjeta={infoTarjeta} setInfoTarjeta={setInfoTarjeta} infoCarrito={cardProduct} setLoad={setLoad} setAlertGlobal={setAlertGlobal} setShowCart={setShowCart} setProductCard={setProductCard}/>
    </p>:<div></div>}
